...
int Android_CreateWindow(_THIS, SDL_Window *window)
{
    ...
    /* Set orientation */
    /* Disabled for Amiberry: We don't want SDL window creation to trigger orientation/size changes */
...
{
    /* Set orientation */
    /* Disabled for Amiberry: We don't want SDL window resize to trigger orientation/size changes */
    /* Android_JNI_SetOrientation(window->w, window->h, window->flags & SDL_WINDOW_RESIZABLE, SDL_GetHint(SDL_HINT_ORIENTATIONS)); */
}
